...
public class ViewResourceHelper {
    ...
    private static final String COMPONENT_FXML_FOLDER = "component/fxml/";
    ...
    public static URL getComponentFxml(Class<?> clazz) {
        return ViewResourceHelper.class.getResource(COMPONENT_FXML_FOLDER + componentControllerToFxml(clazz.getSimpleName()));
    }
    ...
    private static String componentControllerToFxml(String className) {
        className = fromCamelCaseToDash(className).toLowerCase();
        className += FXML_EXT;
        return className;
    }
